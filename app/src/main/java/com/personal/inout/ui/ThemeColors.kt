...
data class ThemeColors(
    ...
    val accent: Color,
    val accentDim: Color = accent.copy(alpha = 0.2f),
...
val AmberTheme = ThemeColors(
    ...
    accentDim = Color(0xFFE2A755).copy(alpha = 0.2f),
...
val OliveMatchaTheme = ThemeColors(
    ...
    accentDim = Color(0xFF88C999).copy(alpha = 0.2f),
...
val NordicSlateTheme = ThemeColors(
    ...
    accentDim = Color(0xFF5BA4E6).copy(alpha = 0.2f),
